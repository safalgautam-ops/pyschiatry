...
function getHeaderTitle(pathname: string) {
  if (pathname.startsWith("/dashboard/doctor/bookings/")) return "Session Workspace"
  if (pathname.startsWith("/dashboard/patient/schedule/")) return "My Session"
  if (pathname.startsWith("/dashboard/doctor/schedule")) return "Doctor Schedule"
  if (pathname.startsWith("/dashboard/doctor/bookings")) return "Session Workspace"
  if (pathname.startsWith("/dashboard/patient/schedule")) return "My Bookings"
  if (pathname.startsWith("/dashboard/doctor")) return "Manage Staff"
